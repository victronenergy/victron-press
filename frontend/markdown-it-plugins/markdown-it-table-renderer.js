...
function table_renderer(state, startLine, endLine, silent) {
  var attrs, ch, lineText, pos, i, nextLine, columns, columnCount, token, aligns, alignCount, t, tableLines, tbodyLines;
  ...
  token.attrs    = attrs = [ [ 'class', 'test-table2' ] ];
...
module.exports = function table_renderer_plugin(md, options) {
  md.block.ruler.at('table', table_renderer, {alt: ['paragraph', 'reference']});
};
