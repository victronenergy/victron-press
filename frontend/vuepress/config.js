    ...
    themeConfig: {
        ...
        locales: {
            ...
            '/de': {
                ...
                unauthorizedCopy: 'Um Änderungen an der Victron-Dokumentation vorzunehmen, müssen Sie Victron Zugriff auf Ihr Github-Konto gewähren.',
                continue: 'Fortsetzen',
                forbiddenHeader: 'Sie haben nicht die richtigen Berechtigungen',
                forbiddenCopy: 'Sie haben sich erfolgreich bei Github angemeldet, aber Ihr Konto verfügt nicht über die erforderlichen Rechte. Bitte wenden Sie sich an Victron Energy und bitten Sie sie, Ihrem Github-Konto die Rechte des Mitwirkenden zu erteilen.',
            ...
            '/es/': {
                ...
                unauthorizedCopy: 'Para realizar cambios en la Documentación de Victron, debe darle acceso a Victron a su cuenta de Github.',
                continue: 'Continuar',
                forbiddenHeader: 'No tienes los permisos correctos',
                forbiddenCopy: 'Has iniciado sesión correctamente en Github, pero tu cuenta no tiene los derechos requeridos. Comuníquese con Victron Energy y pídales que otorguen derechos de colaborador a su cuenta de Github.',
            ...
            '/se/': {
                ...
                unauthorizedCopy: 'För att göra ändringar i Victron-dokumentationen måste du ge Victron tillgång till ditt Github-konto.',
                continue: 'Fortsätta',
                forbiddenHeader: 'Du har inte rätt behörighet',
                forbiddenCopy: 'Du har lyckats logga in på Github, men ditt konto har inte de rättigheter som krävs. Vänligen kontakta Victron Energy och be dem att ge medarbetare rättigheter till ditt Github-konto.',
