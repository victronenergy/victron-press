<template>
    <div class="theme-container">
        ...
        <div
            v-if="!$store.state.isInEditMode && !$store.state.saveSuccess"
            class="content"
        >
        ...
        <ClientOnly>
            <div v-if="$store.state.isInEditMode" class="editor-container">
                <vicpress-editor :mode="'create'"></vicpress-editor>
            </div>
            <div
                v-else-if="$store.state.saveSuccess"
                class="save-success-container"
            >
